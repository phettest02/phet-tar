...
cl.sendText(msg.to, "line://home/post?userMid=" + mid + "&postId=" + cl.new_post(tl_text)[ "result" ]
elif msg.text in [ "Cn " ]:
...
if wait[ "lang" ] == "JP" :
cl.sendText(msg.to,strnum + "The group of people and below decided to automatica
else:
...
elif msg.text in [ "å¼·åˆ¶è‡ªå‹•é€€å‡º:ã‚ªãƒ³" , "Leave on" , "Auto leave:on" , "å¼·åˆ¶è‡ªå‹•é€€å‡ºï¼
if wait[ "leaveRoom" ] == True:
if wait[ "lang" ] == "JP" :
cl.sendText(msg.to, "already on" )
else:
...
elif msg.text in [ "å¼·åˆ¶è‡ªå‹•é€€å‡º:ã‚ªãƒ•" , "Leave off" , "Auto leave:off" , "å¼·åˆ¶è‡ªå‹•é€€å‡º
...
json.dump(wait[ "blacklist" ], f, sort_keys = True, indent = 4 , ensure_ascii = Fa
...
ki.sendText(msg.to, "Ok Cv 󰨁󰄻double thumbs up󿿿" )
kk.sendText(msg.to, "Ok Cv 󰨁󰄻double thumbs up󿿿" )
kc.sendText(msg.to, "Ok Cv 󰨁󰄻double thumbs up󿿿" )
#-----------------------------------------------
elif "Bc " in msg.text:
...
ki.sendText(msg.to, "Hi buddy 󰜁󰅔Har Har󿿿" )
kk.sendText(msg.to, "Hi buddy 󰜁󰅔Har Har󿿿" )
kc.sendText(msg.to, "Hi buddy 󰜁󰅔Har Har󿿿" )
#-----------------------------------------------
elif msg.text in [ "Cv say hinata pekok" ]:
ki.sendText(msg.to, "Hinata pekok 󰜁󰅔Har Har󿿿" )
kk.sendText(msg.to, "Hinata pekok 󰜁󰅔Har Har󿿿" )
kc.sendText(msg.to, "Hinata pekok 󰜁󰅔Har Har󿿿" )
elif msg.text in [ "Cv say didik pekok" ]:
ki.sendText(msg.to, "Didik pekok 󰜁󰅔Har Har󿿿" )
kk.sendText(msg.to, "Didik pekok 󰜁󰅔Har Har󿿿" )
kc.sendText(msg.to, "Didik pekok 󰜁󰅔Har Har󿿿" )
elif msg.text in [ "Cv say bobo ah" , "Bobo dulu ah" ]:
ki.sendText(msg.to, "Have a nice dream Cv 󰜁󰅔Har Har󿿿" )
kk.sendText(msg.to, "Have a nice dream Cv 󰜁󰅔Har Har󿿿" )
kc.sendText(msg.to, "Have a nice dream Cv 󰜁󰅔Har Har󿿿" )
elif msg.text in [ "Cv say chomel pekok" ]:
ki.sendText(msg.to, "Chomel pekok 󰜁󰅔Har Har󿿿" )
kk.sendText(msg.to, "Chomel pekok 󰜁󰅔Har Har󿿿" )
kc.sendText(msg.to, "Chomel pekok 󰜁󰅔Har Har󿿿" )
elif msg.text in [ "#welcome" ]:
ki.sendText(msg.to, "Selamat datang di Chivas Family Room" )
kk.sendText(msg.to, "Jangan nakal ok!" )
#-----------------------------------------------
elif msg.text in [ "PING" , "Ping" , "ping" ]:
ki.sendText(msg.to, "PONG 󰨁󰄻double thumbs up󿿿󰜁󰅔Har Har󿿿" )
kk.sendText(msg.to, "PONG 󰨁󰄻double thumbs up󿿿󰜁󰅔Har Har󿿿" )
kc.sendText(msg.to, "PONG 󰨁󰄻double thumbs up󿿿󰜁󰅔Har Har󿿿" )
#-----------------------------------------------
